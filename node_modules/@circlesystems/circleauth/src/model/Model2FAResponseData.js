...
export class Model2FAResponseData {
   ...
   * @class
   * @param factorUrl {String} The URL that will open Unic Auth website or the app to request the user acceptance. Check [Factor Authentication](#section/FactorAuthentication)). acceptance.
...
/**
 * The URL that will open Unic Auth website or the app to request the user acceptance. Check [Factor Authentication](#section/FactorAuthentication)). acceptance.
